    ...
    <div className="row">
      ...
      <div className="col-6 p-2" style={borderStyle}>
        ...
        <div className="text-center mt-3 mb-5">
          <strong>{smallText("Signed for the Carrier")}</strong>
        </div>
        <hr />
...
const Section2 = (document: BLCertificateShell): JSX.Element => {
...
const Section1 = (document: BLCertificateShell): JSX.Element => {
      ...
      <div className="d-flex">
        <div className="p-2 col-6" style={{ ...borderStyle }}>
          <div className="d-flex align-items-center justify-content-center h-100 text-center">
            ...
            <img style={{ width: "150px" }} src="/static/images/Shell_logo.png" />
          </div>
        </div>
...
export const BillOfLadingShellTemplate: FunctionComponent<TemplateProps<BLCertificateShell>> = ({ document }) => {
